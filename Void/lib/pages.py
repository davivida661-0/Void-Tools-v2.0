...
def _discord_pages():
    return [
        ...
        ("12", "Token-Generator", _p("Token-Generator")),
        ("13", "Token-Joiner", _p("Token-Joiner")),
        ("14", "Token-Nuker", _p("Token-Nuker")),
        ("15", "Nitro Sniper", _p("Nitro Sniper")),
        ("16", "Username Sniper", _p("Username Sniper")),
        ("17", "Vanity Sniper", _p("Vanity Sniper")),
        ("18", "Mass DM", _p("Mass DM")),
        ("19", "Mass Report", _p("Mass Report")),
        ("20", "Token Checker Pro", _p("Token Checker Pro")),
        ("21", "Account Creator", _p("Account Creator")),
        ("22", "Boost Sniper", _p("Boost Sniper")),
        ("23", "Friend Spammer", _p("Friend Spammer")),
        ("24", "Server Cloner Pro", _p("Server Cloner Pro")),
        ("25", "Anti-Ban Token", _p("Anti-Ban Token")),
    ]
...
def _social_pages():
    return [
        ...
        ("09", "TikTok-Follow", _p("TikTok-Follow")),
        ("10", "TikTok-Like", _p("TikTok-Like")),
        ("11", "TikTok-Views", _p("TikTok-Views")),
        ("12", "Instagram-Follow", _p("Instagram-Follow")),
        ("13", "Instagram-Like", _p("Instagram-Like")),
        ("14", "YouTube-Views", _p("YouTube-Views")),
        ("15", "YouTube-Like", _p("YouTube-Like")),
        ("16", "X-Follow", _p("X-Follow")),
        ("17", "X-Like", _p("X-Like")),
        ("18", "Telegram-Member", _p("Telegram-Member")),
    ]
...
def _roblox_pages():
    return [
        ...
        ("19", "Roblox-Stealer", _p("Roblox-Stealer")),
        ("20", "Roblox-Account Gen", _p("Roblox-Account Gen")),
        ("21", "Roblox-Mass Report", _p("Roblox-Mass Report")),
        ("22", "Roblox-Trade Bot", _p("Roblox-Trade Bot")),
        ("23", "Roblox-Anti-Ban", _p("Roblox-Anti-Ban")),
    ]
...
def build_pages_data(plugin_items=None):
    ...
    pages = {
        ...
        "osint": [
            ...
            ("16", "ID-To-IP", _p("Discord ID-To-IP")),
        ],
        "attack": [
            ...
            ("05", "Token-Grabber", _p("Token-Grabber")),
            ("06", "Rar Cracker", lambda: run("rar-cracker")),
            ("07", "DDOS", _p("DDOS")),
            ("08", "Token-Bomber", _p("Token Bomber")),
            ("09", "Admin-Panel", _p("Admin-Panel")),
            ("10", "Discord-SelfBot", _p("Discord-SelfBot")),
        ],
        "nuker": _nuker_pages(),
